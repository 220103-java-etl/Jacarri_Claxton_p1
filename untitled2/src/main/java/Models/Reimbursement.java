...
public class Reimbursement extends AbstractReimbursement {
     ...
     */
    public Reimbursement(int id, String status, User author, User resolver, double amount, String date, String time, String location, String description, String justify) {
